...
import { AIBadgeComponent } from "../AIBadgeComponent"
...
const heroActionsVariants: { container: Variants; item: Variants } = {
  container: {
    visible: {
      transition: {
...
const heroShowcaseVariants: { container: Variants; item: Variants } = {
  container: {
    visible: {
      transition: {
        staggerChildren: 0.05,
